...
p1 = (13.262452999481667, 17.244540004791123)
p2 = (13.262452999481667, 20.31729862980733)
...
class WaypointNavigator(Node):
    def __init__(self):
        ...
        self.compute_path_client = ActionClient(self, ComputePathThroughPoses, '/robot4/compute_path_through_poses')
