...
# WAYPOINTS = [
#             (-1.1888759073286665, 0.8567395337275825),
#             (-1.7573231267877698, 1.1763000837780282),
#             (-2.0487147682992837, 0.8567395337275825),
#             (-2.761993990854728, 0.8567395337275825),
#             (-2.523020336341442, 1.1763000837780282),
#             (-3.0333638445221593, 1.1763000837780282),
#             (-3.575691666712014, 0.8567395337275825)
#         ]
# import numpy as np
...
# xs = np.linspace(min(waypoints[:, 0]), max(waypoints[:, 0]), 20)
# ys = spline(xs)
